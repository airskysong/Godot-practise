...
onready var color_rect = $transition/fade
...
func set_state(value:int)->void:
	match value:
		IN:
			tween.interpolate_property(self, "percent", 1, 0, fade_transition, Tween.TRANS_LINEAR,Tween.EASE_IN)
		OUT:
			tween.interpolate_property(self, "percent", 0, 1, fade_transition, Tween.TRANS_LINEAR,Tween.EASE_IN)
	tween.start()
